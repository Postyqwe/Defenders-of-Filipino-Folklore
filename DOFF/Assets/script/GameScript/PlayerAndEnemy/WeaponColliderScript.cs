...
public class WeaponColliderScript : MonoBehaviour
{
    private void OnTriggerEnter(Collider collision)
    {
        ...
        else if (collision.gameObject.CompareTag("BossRange")) //Check if it collides with an object with the "BossRange" tag.
        {
        ...
        else if (collision.gameObject.CompareTag("Kapre")) //Check if it collides with an object with the "Kapre" tag.
        {
        ...
        else if (collision.gameObject.CompareTag("Tikbalang")) //Check if it collides with an object with the "Tikbalang" tag.
        {
            BossScript boss = collision.gameObject.GetComponent<BossScript>();
